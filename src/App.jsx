      ...
      {showUpgradeModal && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.85)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 100, padding: "1rem", backdropFilter: "blur(8px)" }}>
          <div className="card fade-in" style={{ padding: "2.5rem", maxWidth: 420, width: "100%", textAlign: "center" }}>
            ...
            <p style={{ margin: "0 0 24px", fontSize: 14, color: "#9d9aa6", lineHeight: 1.6 }}>Upgrade to Pro for unlimited mood boards, unlimited saves, clean PNG exports, brand kit downloads and full access — just $7/month.</p>
            ...
            {result && !result.error && (
              <div id="mood-board-result" className="fade-in">
                ...
                <div style={{ display: "flex", gap: 8, flexWrap: mobile ? "wrap" : "nowrap" }}>
                  ...
                  <button className="btn-secondary" onClick={exportBrandKit} style={{ fontSize: 13, padding: "10px 18px", flex: mobile ? "1 1 auto" : "none", color: isPro ? "#a78bfa" : "#6b6870" }}>
                    {isPro ? "Brand Kit ✦" : "Brand Kit 🔒"}
                  </button>
                </div>
              </div>
            )}
