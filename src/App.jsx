        ...
        <div style={{ maxWidth: 720, margin: "0 auto", padding: "2rem" }}>
          <div style={{ display: "flex", gap: 10, marginBottom: "2rem" }}>
            <input
              ...
              onKeyDown={e => e.key === "Enter" && generate(input.trim())}
            ...
            />
            <button onClick={() => generate(input.trim())} disabled={loading || !input.trim()} style={{
              background: "#8b5cf6", border: "none", borderRadius: 10, color: "#fff",
