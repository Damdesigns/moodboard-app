          ...
          <>
            ...
            {!showQuiz && !result && !loading && (
              <div style={{ textAlign: "center", marginBottom: "1.5rem" }}>
                <button onClick={() => setShowQuiz(true)} style={{ background: "transparent", border: "0.5px solid rgba(139,92,246,0.3)", borderRadius: 20, color: "#9d9aa6", fontSize: 13, padding: "8px 20px", cursor: "pointer", fontFamily: "inherit", transition: "all 0.2s" }}>
